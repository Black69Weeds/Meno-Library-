...
--[[
    Milenium Library - Fixed & Improved
]]
...
-- Library init
    ...
    -- FIX: Darker, Cleaner Theme Palette
    local dark_theme = {
        main_bg = rgb(10, 10, 12),      -- Darker black/blue
        side_bg = rgb(15, 15, 18),      -- Slightly lighter for sidebar
        stroke = rgb(25, 25, 30),       -- Subtle stroke
        text = rgb(240, 240, 240),      -- Brighter text
        text_dark = rgb(160, 160, 160)  -- Secondary text
    }
...
-- Library functions 
    ...
    function library:key_system(settings, on_success)
        ...
        -- FIX 1: Stored back_fade in variable so we can tween it later
        ...
        local main_frame = library:create("Frame", {
            ...
            BackgroundColor3 = dark_theme.side_bg, -- FIX 2: Better theme
            BorderSizePixel = 0,
            ClipsDescendants = true
        })

        library:create("UICorner", {Parent = main_frame, CornerRadius = dim(0, 12)})
        library:create("UIStroke", {Parent = main_frame, Color = dark_theme.stroke, ApplyStrokeMode = Enum.ApplyStrokeMode.Border, Thickness = 1})
        ...
        local input_bg = library:create("Frame", {
            ...
            BackgroundColor3 = dark_theme.main_bg -- FIX 2
        })
        ...
        check_btn.MouseButton1Click:Connect(function()
            if find(settings.Key, input_box.Text) then
                ...
                -- FIX 1: Fading out the Black Background Box (back_fade)
                tween_service:Create(back_fade, TweenInfo.new(0.5), {BackgroundTransparency = 1}):Play()
        ...
        function library:window(properties)
            ...
            local items = cfg.items; do
                items[ "main" ] = library:create( "Frame" , {
                    ...
                    BorderSizePixel = 0;
                    BackgroundColor3 = dark_theme.main_bg -- FIX 2: Darker Theme
                ...
                items[ "side_frame" ] = library:create( "Frame" , {
                    ...
                    BorderSizePixel = 0;
                    BackgroundColor3 = dark_theme.side_bg -- FIX 2
                });
                ...
                -- FIX 3: IMPROVED SMALL OPEN BUTTON
                local open_button_frame = library:create("TextButton", {
                    ...
                    Size = dim2(0, 130, 0, 35), -- Slightly wider
                    BorderSizePixel = 0
                })
                
                library:create("UICorner", {Parent = open_button_frame, CornerRadius = dim(0, 8)}) -- Rounder
                ...
                library:create("UIGradient", {
                    ...
                    Color = ColorSequence.new{
                        ColorSequenceKeypoint.new(0, rgb(30, 30, 35)),
                        ColorSequenceKeypoint.new(1, rgb(15, 15, 18))
                    },
                    Rotation = 90
                })

                -- Icon for button
                local open_icon = library:create("ImageLabel", {
                    Parent = open_button_frame,
                    Size = dim2(0, 20, 0, 20),
                    Position = dim2(0, 10, 0.5, -10),
                    BackgroundTransparency = 1,
                    Image = "rbxassetid://6031075931", -- Menu icon
                    ImageColor3 = themes.preset.accent
                })
                library:apply_theme(open_icon, "accent", "ImageColor3")
                ...
                -- FIX 4: LONG TITLE FIX (Added TextScaled and Constraint)
                items[ "title" ] = library:create( "TextLabel" , {
                    ...
                    BackgroundTransparency = 1;
                    Size = dim2(1, -20, 1, 0); -- Padding from edges
                    Position = dim2(0, 10, 0, 0);
                    TextColor3 = themes.preset.accent;
                    BorderSizePixel = 0;
                    RichText = true;
                    TextScaled = true; -- Fixes overflowing text
                    TextWrapped = true;
                    BackgroundColor3 = rgb(255, 255, 255)
                }); library:apply_theme(items[ "title" ], "accent", "TextColor3");
                
                -- Limit text size if it gets too big due to TextScaled
                library:create("UITextSizeConstraint", {Parent = items["title"], MaxTextSize = 30})
        ...
        function library:section(properties)
            ...
            local items = cfg.items; do 
                items[ "outline" ] = library:create( "Frame" , {
                    ...
                    BorderSizePixel = 0;
                    BackgroundColor3 = dark_theme.stroke -- FIX 2
                });
